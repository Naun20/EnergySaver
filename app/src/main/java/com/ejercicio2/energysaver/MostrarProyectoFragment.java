...
public class MostrarProyectoFragment extends Fragment {
    ...
    public MostrarProyectoFragment() {
        // Constructor público vacío
    }

    public static MostrarProyectoFragment newInstance(String imageUrl, String title, String description, String date) {
        MostrarProyectoFragment fragment = new MostrarProyectoFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mostrar_proyecto, container, false);
        ...
        btnCerrar.setOnClickListener(v -> {
            ...
            if (getActivity() != null) {
                getActivity().getSupportFragmentManager().beginTransaction().remove(MostrarProyectoFragment.this).commit();
            }
        });
